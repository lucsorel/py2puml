...
def to_puml_content(uml_items: List[UmlItem], uml_relations: List[UmlRelation]) -> Iterable[str]:
    ...
    for uml_item in uml_items:
        if isinstance(uml_item, UmlEnum):
            ...
            yield PUML_ITEM_START_TPL.format(item_type='enum', item_fqdn=uml_enum.fqdn, item_style='')
            ...
            yield PUML_ITEM_START_TPL.format(item_type='class', item_fqdn=uml_class.fqdn, item_style='')
