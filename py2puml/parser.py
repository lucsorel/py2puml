...
def get_type_name(type: Type, root_module_name: str, current_module: str):
...
def parse_item_module(
    ...
    for definition_type in filter_domain_definitions(domain_item_module, root_module_name):
        parse_type(definition_type, root_module_name, domain_classes_by_fqdn, domain_compositions)
